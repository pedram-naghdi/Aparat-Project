...
const SearchForm = () => {
    ...
    return (
        <form className={`search-input w-[450px] md:w-[320px] lg:w-[550px] max-w-full p-3 rounded-full flex bg-gray-100 border border-transparent ${searchTextFocus ? "focused" : ""}`}>
