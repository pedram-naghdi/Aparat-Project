...
const VideoDetails = ({videoID}:any) => {
    ...
    useEffect(() => {
        ...
        async function getVideo() {
            await axios({
                ...
                setTags(response.data.video.tags)
            }, (error) => {
                console.log(error)
            })
        }
    ...
    return ( 
        <div className="flex">
            <div className="video w-full md:w-[calc(100%-300px)]">
                <div className="video w-full px-4 pb-8">
                    ...
                    <div className="flex items-start gap-2 justify-between my-5 flex-col md:flex-row md:items-center md:gap-5">
                        ...
                        <div className="likes flex items-center justify-between gap-3">
                            ...
                            <span className="flex items-center justify-between text-[12px] gap-1">
                                K<span>{Math.round(video.size / 1024)}</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                    ...
                    <div className="tags flex items-center justify-start mt-5 text-gray-500 text-[11px]">
                        <span className="date flex items-center gap-1 ml-5">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                        ...
                        {   
                        tags.map((tag:any) => (
                            <a href={`tag/${tag.name.replace(/ /g,"_")}`}>
            ...
            <div className="relative-videos w-full md:w-[300px] pr-3">
