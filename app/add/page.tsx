...
const Add = () => {
    return (
        <div className="text-center flex flex-col content-center items-center my-10">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-20 h-20 text-blue-600 mb-3">
            ...
            <h2 className="text-2xl font-bold pb-2">صفحه در دست طراحی است</h2>
            <p className="mb-5">این بخش در حال طراحی است و در آینده در دسترس خواهد بود.</p>
