const SearchLoading = ({searchText}) => {
    return (
        <>


        <div className="page-title flex justify-between gap-1 mb-7 pb-2 border-b border-gray-100">
            <h3 className="text-gray-200 dark:text-gray-700">نتایج یافت شده برای عبارت «<span className="text-gray-200 dark:text-gray-700">{decodeURI(searchText)}</span>»</h3>
        </div>
