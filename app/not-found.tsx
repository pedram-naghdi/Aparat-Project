...
export default function Error_404() {
  return (
    <div className="text-center flex flex-col content-center items-center my-10">
      ...
      <p className="mb-3">متاسفانه صفحه مورد نظر شما یافت نشد.</p>
      <Link href="/" className="bg-blue-600 p-3 rounded-full text-white text-xs hover:bg-blue-400">بازگشت به صفحه اصلی</Link>
    </div>
  );
}